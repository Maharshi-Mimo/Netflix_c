...
cd /etc/prometheus
``` 
- Open the prometheus .yml file using a text editor (e.g., nano or vim). A
``` bash 
sudo nano prometheus.yml" 
```
- Add following lines at the end of `prometheus.yml` file:
...
<div align = "center">
<img src= "/public/assets/Grafana_dash_node_exporter.png"  width=100% height=100% alt = "Grafana Dashboard" title = "Grafana Dashboard" />
<br> 
<p> Grafana Dashboard of Nodes </p>
</div>
